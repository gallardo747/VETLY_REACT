...
var r = { name: "auth0-spa-js", version: "2.1.0" };
var c = () => Date.now();
...
var E = (e2) => {
  ...
  if (e2.organization) {
    ...
    if (i3.startsWith("org_")) {
      ...
      if (e3 !== t2.claims.org_name.toLowerCase())
        throw new Error(`Organization Name (org_name) claim mismatch in the ID token; expected "${e3}", found "${t2.claims.org_name.toLowerCase()}"`);
    }
  }
  return t2;
};
